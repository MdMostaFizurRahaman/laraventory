            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5>Edit Product Category Info</h5>
                    </div>

                    {!! Form::model($categories, ['method'=>'PATCH', 'action'=>['ProductCategoryController@update',
                    $subdomain, $categories->id]]) !!}
                    <div class="card-body">
                        <div class="col-md-6">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{route('product-categories.index', $subdomain)}}" type="submit"
