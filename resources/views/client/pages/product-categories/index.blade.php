    ...
    <div class="content-header">
        <div class="row mb-2">
            <div class="col-md-12">
                ...
                <a href="{{route('product-categories.create', $subdomain)}}" type="submit" class="btn btn-primary float-right">Add New Category</a>
                @endif
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline">
                    {!! Form::open(['method'=>'GET', 'action'=>['ProductCategoryController@index',$subdomain]]) !!}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Auth::user()->can('update-product-categories'))
                                        <a href="{{route('product-categories.edit', [$subdomain, $category->id])}}"
                                            class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
                                        @endif

                                        @if(Auth::user()->hasRole('admin') ||
                                        Auth::user()->can('delete-product-categories'))
                                        ...
                                        'action'=>['ProductCategoryController@destroy',$subdomain, $category->id],
