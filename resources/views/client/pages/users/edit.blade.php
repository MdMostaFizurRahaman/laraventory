        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    {!! Form::model($user, ['route' => ['users.update', $subdomain, $user->id], 'method' =>'put',
                    'files'=>true]) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('role_id',['' => 'Choose an option'] + $roles,
                                    $user->roles()->first()->id, ['class' => 'form-control select2']) !!}
