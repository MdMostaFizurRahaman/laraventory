...
<div class="content">
    <div class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Edit Cost</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div>
            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5>Update Cost Info</h5>
                    </div>

                    {!! Form::model($cost, ['method'=>'PATCH', 'action'=>['CostController@update',
                    $subdomain, $cost->id]]) !!}
                    ...
                    <div class="card-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('cost_type_id',['' => 'Choose an option'] + $costTypes, null, ['class'
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('purchase_id',['' => 'Choose an option'] + $purchases, null, ['class'
                                => 'form-control select2']) !!}
