        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    ...
                    {!! Form::model($account, ['route' => ['accounts.update', $subdomain, $account->id], 'method'
                    =>'put']) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::select("status",['' => 'Choose an option'] + Config::get('constant.BANK_ACCOUNT_STATUSES'),null,["class" => "form-control select2"])}}
