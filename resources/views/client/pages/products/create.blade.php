            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5>Create Product Info</h5>
                    </div>
                    {!! Form::open(['route' => ['products.store', $subdomain], 'method' =>'post', 'files'=>true]) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                {{-- <div class="form-group">
                                    {{ Form::label("opening_quantity","Opening Quantity") }}
                                {{Form::text("opening_quantity", 0,["class" => "form-control",'oninput'=>"this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"])}}
                                @if ($errors->has('opening_quantity'))
                                <div class="error text-danger">{{ $errors->first('opening_quantity') }}</div>
                                @endif
                            </div> --}}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="icheck-primary">
                                    {!! Form::checkbox('is_numeric', 1, null, ['id'=>'is_numeric', 'class'=>'form-control']) !!}
