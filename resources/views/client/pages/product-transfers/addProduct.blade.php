...
<div class="content">
    <div class="content-header">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h3 class="m-0 text-dark">Add Product to Transfer Batch #{{ $productTransfer->pt_number }}</h3>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    ...
                    {!! Form::open(['action'=>['ProductTransferController@addProductStore', $subdomain,
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('total', old('product_id') ? $price : null, ['class' => 'form-control
                                    total readonly' ,
                                    'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g,
                                    '$1');"]) !!}
                                    @if ($errors->has('total'))
