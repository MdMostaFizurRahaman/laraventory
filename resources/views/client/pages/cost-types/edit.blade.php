            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5>Edit Cost Type Info</h5>
                    </div>

                    {!! Form::model($costType, ['method'=>'PATCH', 'action'=>['CostTypeController@update',
                    $subdomain, $costType->id]]) !!}

                    <div class="card-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('name', 'Cost Type Name') !!}
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{route('cost-types.index', $subdomain)}}" type="submit" class="btn btn-danger">
                            Cancel</a>
                        @endif
