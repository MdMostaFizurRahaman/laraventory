...
<div class="content">
    <div class="content-header">
        <div class="row mb-2">
            <div class="col-md-6">
                <h1 class="m-0 text-dark">Permission Group List</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Auth::guard('admin')->user()->can('update-client-permissions'))
                                        ...
                                        @if(Auth::guard('admin')->user()->hasRole('admin') ||
                                        Auth::guard('admin')->user()->can('delete-client-permissions'))
                                        ...
                                        'action'=>['Admin\PermissionController@destroy', $permission->id],
