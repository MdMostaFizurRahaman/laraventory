...
<div class="content">
    <div class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Update Client Info</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::email("secondary_email", $client->secondary_email,["class" => "form-control"])}}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('client_website', $client->client_website, ['class'=>'form-control'])
                                    !!}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('client_url', $client->client_url, ['class'=>'form-control']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    Config::get('constant.ACTIVE_CLIENT_STATUSES'), $client->status,
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('contact_person_name', $client->contact_person_name,
                                    ['class'=>'form-control']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('contact_person_phone', $client->contact_person_phone,
                                    ['class'=>'form-control']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    !!}
                                    {!! Form::text('contact_person_secondary_phone',
                                    $client->contact_person_secondary_phone, ['class'=>'form-control']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('contact_person_email', $client->contact_person_email,
                                    ['class'=>'form-control']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('address', $client->address, ['class'=>'form-control', 'size' =>
                                    '30x4']) !!}
